...
export function authentication(personURI, personAuth, resultsURI, homeInstitution, scope, path) {
  formPost({ personURI, personAuth, resultsURI, homeInstitution, scope}, path)
}
